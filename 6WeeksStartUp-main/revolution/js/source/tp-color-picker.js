...
(function($) {
	...
	jQuery.fn.tpColorPicker = function(settings) {
		...
		return this.each(function() {
			...
			var wrap = $.find('<span class="rev-colorpicker"></span>').data('revcolorinput', $this),
			...
			if(!wrapper) {
				...
				wrapper = $.find(wrapper).addClass('rev-cpicker-master-wrap');
				wrap.wrap(wrapper)
